...
turma: Turma
turma = [ ("Joao",7,4.5), ("Maria",10,8), ("Jessica", 9,7.5), ("Jorge", 6,8.5), ("Alan", 3, 5) ]       -- 50 alunos
...
total: Float
total = (List.foldl soma 0 (List.map media turma)) / (List.foldl cont 0 turma)
